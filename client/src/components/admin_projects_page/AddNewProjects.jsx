...
const AddNewProject = ({ onClose, fetchProjects }) => {
  ...
  const handleSubmit = async(e) => {
    ...
    // console.log();
    try{
      const response = await axiosInstance.post("/admin/createProject", {
        ...formData, latitude: position[0], longitude: position[1], employees
      });
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-white p-8 rounded-lg shadow-lg w-[600px] max-w-xl relative">
        <span className="flex gap-x-2 items-center mb-6">
          ...
          <h2 className="text-2xl font-medium text-left">New Project</h2>
        </span>
